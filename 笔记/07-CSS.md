...
### 轮廓 outline
 ...
 是绘制于元素周围	的一条线，位于边框边缘的外围，可起到突出元素的作用。
...
***注意一定要首先强制一行内显示，再次和overflow：hidden属性  搭配使用***

## CSS精灵图技术（sprite） 小妖精  雪碧
...
<img src="media/03.jpg" />
  ...
  之后保存为svg格式，然后给我们前端人员就好了。 （一般都是使用现成的字体图标）
